...
module.exports = Docke = (function() {
  ...
  Docke.prototype.ping = function(callback) {
    return this._modem.get('/_ping', function(err, result) {
      if (err != null) {
        return callback(err);
      }
  ...
  Docke.prototype.ps = function(callback) {
    return this._modem.get('/containers/json', (function(_this) {
      return function(err, containers) {
        ...
        _fn = function(container) {
          return tasks.push(function(cb) {
            return _this._modem.get("/containers/" + container.Id + "/json", function(err, inspect) {
              if (err != null) {
                errors.push(err);
                return cb();
              }
